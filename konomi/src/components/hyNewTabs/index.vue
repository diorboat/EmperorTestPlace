<template>
  <div class='hyTabs'>
    <el-tabs class='tabs' v-model="mySelectTab" :type="type" :closable="closable" @tab-remove="removeTab" @tab-click='tabClick'>
      <el-tab-pane v-for="item in myTabData" :key="item.name" :label="item.title" :name="item.name" :disabled="item.disabled">
